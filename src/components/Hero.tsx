        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
          ...
          >
            ...
            <Typography
              ...
              className="gradient-text-advanced typewriter"
            >
              Твій особистий
              <br />
              <Box
              ...
              >
                <img 
                  ...
                  className="floating pulse-glow transform-3d"
                  onError={(e) => {
            ...
            <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', mb: 6, justifyContent: 'center' }}>
              <Button
                ...
                className="btn-hover sparkle ripple-effect hover-lift"
              >
                Розпочати роботу
              </Button>
              ...
              <Button
                ...
                className="btn-hover glass-advanced hover-lift"
              >
                Дізнатись ціни
              </Button>
            </Box>
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: { xs: 'repeat(2, 1fr)', md: 'repeat(4, 1fr)' }, gap: 3 }}>
              {features.map((feature, index) => (
                <Card
                  ...
                  className="card-hover glass-advanced transform-3d floating"
